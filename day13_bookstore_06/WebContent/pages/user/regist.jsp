...
<script type="text/javascript">
	$(function(){
		var i=0;
		$("#code").click(function(){
			//浏览器问题，如果多次请求同一个路径，浏览器不会发送请求而是使用缓存
			this.src="${pageContext.request.contextPath}/code.jpg?1="+(i++);
		})
						...
						<div class="login_box">
							...
							<div class="form">
								...
								<input type="hidden" name="method" value="regist">
									...
									<img id="code" alt="" src="code.jpg" style="float: right; margin-right: 40px;width:80px;height:40px">									
									<br />
									<br />
